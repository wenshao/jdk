...
public class TestStringFormatOptimization {
    ...
    static String testFormat_XNull() { return String.format("%X", (Object) null); }
    static String testFormat_dNullWidth() { return String.format("[%5d]", (Object) null); }

    // ========== BigInteger tests ==========

    static String testFormat_dBigInt(java.math.BigInteger v) { return String.format("big=%d", v); }
    static String testFormat_xBigInt(java.math.BigInteger v) { return String.format("hex=%x", v); }
    static String testFormat_XBigInt(java.math.BigInteger v) { return String.format("HEX=%X", v); }
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 20_000; i++) {
            ...
            check("null", testFormat_XNull());
            check("[ null]", testFormat_dNullWidth());

            // ===== BigInteger tests =====
            check("big=42", testFormat_dBigInt(java.math.BigInteger.valueOf(42)));
            check("big=-123", testFormat_dBigInt(java.math.BigInteger.valueOf(-123)));
            check("hex=ff", testFormat_xBigInt(java.math.BigInteger.valueOf(255)));
            check("hex=-ff", testFormat_xBigInt(java.math.BigInteger.valueOf(-255)));
            check("HEX=FF", testFormat_XBigInt(java.math.BigInteger.valueOf(255)));
            check("HEX=-FF", testFormat_XBigInt(java.math.BigInteger.valueOf(-255)));
