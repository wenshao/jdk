            ...
            if (use->is_CallStaticJava()) {
              ...
              if (next_method != nullptr &&
                ...
                if (next_method->signature()->as_symbol() == expected_next_char_sig) {
                  ...
                  if (append_pair_method != nullptr && append_pair_method->intrinsic_id() != vmIntrinsics::_none && 
                      method->holder() == C->env()->StringBuilder_klass()) {  // Only StringBuilder has this optimization
