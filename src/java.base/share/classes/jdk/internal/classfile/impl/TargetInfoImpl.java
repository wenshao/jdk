...
public final class TargetInfoImpl {
    ...
    public record SupertypeTargetImpl(int supertypeIndex)
            implements SupertypeTarget {
        @Override
    ...
    public record EmptyTargetImpl(TargetType targetType)
            implements EmptyTarget {
        public EmptyTargetImpl(TargetType targetType) {
            this.targetType = checkValid(targetType, TARGET_FIELD, TARGET_METHOD_RECEIVER);
        }
    }

    public record FormalParameterTargetImpl(int formalParameterIndex)
            implements FormalParameterTarget {
        @Override
        public TargetType targetType() {
    ...
    public record ThrowsTargetImpl(int throwsTargetIndex)
            implements ThrowsTarget {
        @Override
        public TargetType targetType() {
    ...
    public record CatchTargetImpl(int exceptionTableIndex)
            implements CatchTarget {
        @Override
        public TargetType targetType() {
    ...
    public record OffsetTargetImpl(TargetType targetType, Label target)
            implements OffsetTarget {
