...
public final class LazyLoggers {
    ...
    static sealed interface LoggerAccessor permits LazyLoggerAccessor {
        /**
         * The logger name.
     ...
     */
    sealed static class LazyLoggerWrapper
        extends AbstractLoggerWrapper<Logger> permits JdkLazyLogger {
