...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
    ...
    public static UUID fromString(String name) {
        if (name.length() == 36) {
            ...
            if (ch1 == '-' && ch2 == '-' && ch3 == '-' && ch4 == '-') {
                long msb1 = HexFormat.parse4Nibbles(name, 0);
                long msb2 = HexFormat.parse4Nibbles(name, 4);
                long msb3 = HexFormat.parse4Nibbles(name, 9);
                long msb4 = HexFormat.parse4Nibbles(name, 14);
                long lsb1 = HexFormat.parse4Nibbles(name, 19);
                long lsb2 = HexFormat.parse4Nibbles(name, 24);
                long lsb3 = HexFormat.parse4Nibbles(name, 28);
                long lsb4 = HexFormat.parse4Nibbles(name, 32);
