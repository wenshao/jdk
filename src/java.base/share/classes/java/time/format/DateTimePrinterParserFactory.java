...
final class DateTimePrinterParserFactory {
     ...
     *      ...
     *      private final DateTimePrinterParser printerParserN;
     *
     ...
     *          return printerParser0.format(context, buf, optional)
     *              && printerParser1.format(context, buf, optional)
     *              && printerParser2.format(context, buf, optional)
     *                 ...;
     *      }
     *  }
     *
    ...
    static DateTimeFormatterBuilder.DateTimePrinter createFormatter(DateTimeFormatterBuilder.DateTimePrinterParser[] printerParsers, boolean optional) {
        ...
        try {
            ...
            var hiddenClass = JLA.defineClass(loader, lookupClass, className, classBytes,
                    (loader != null) ? JLA.protectionDomain(lookupClass) : null,
                    true,
